...
def build_har_transformer(args):
    return Transformer(
        d_model=args.hidden_dim,
        dropout=args.dropout,
        nhead=args.HHI_nheads,
        dim_feedforward=args.HHI_dim_feedforward,
        num_encoder_layers=args.HHI_enc_layers,
        num_decoder_layers=args.HHI_dec_layers,
        normalize_before=args.pre_norm,
        return_intermediate_dec=True,
    )
